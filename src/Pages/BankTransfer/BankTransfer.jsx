...
// import { useGetAllTransactionQuery, useUpdateTransferRefundMutation } from "../../redux/Api/transactionApi";
// import { Table } from "antd";
// import user1 from "../../assets/images/user01.png";
// import user2 from "../../assets/images/user02.png";
// export const BankTransfer = ({ pagination }) => {
...
const BankTransfer = () => {
  ...
  const { data, isLoading, isError } = useGetAllRefundedQuery({
    status:'succeeded',
    page: currentPage, // Ensure correct page number is passed
    limit: pageSize,
  ...
  console.log(totalTransactions); // Total transactions for pagination
  ...
  return (
    <div className="p-2 shadow-md">
      ...
      {/* Show loading or transaction table */}
      {isLoading ? (
